...
class StackedEnsembleRegression:
    def __init__(self, sub_estimator, aggregator_estimator, feature_name, layers, model_number_layer, feature_ratio,
                 sample_ratio, random_state):
        self.sub_estimator = {}
    ...
    def fit(self, X, Y):
        ...
        while n < self.layers:
            ...
            for m in range(num):
                ...
                columns_select = random.sample(self.feature_name,
                                               int(round(len(self.feature_name) * self.feature_ratio)))
